...
// Derived from lazygit's icon mappings (MIT License).
// Source: /tmp/lazygit/pkg/gui/presentation/icons/file_icons.go
...
var (
	defaultFileIcon      = iconProperties{Icon: "\uf15b", Color: "#878787"} // 
	defaultDirectoryIcon = iconProperties{Icon: "\uf07b", Color: "#878787"} // 
)
...
var extIconMapV3 = map[string]iconProperties{
...
func patchFileIconsForNerdFontsV2(iconMap map[string]iconProperties) {
	iconMap[".cs"] = iconProperties{Icon: "\uf81a", Color: "#FEDECA"}      // 
	iconMap[".csproj"] = iconProperties{Icon: "\uf81a", Color: "#AB48BC"}  // 
	iconMap[".csx"] = iconProperties{Icon: "\uf81a", Color: "#0188D1"}     // 
	iconMap[".license"] = iconProperties{Icon: "\uf718", Color: "#626262"} // 
	iconMap[".node"] = iconProperties{Icon: "\uf898", Color: "#E8274B"}    // 
	iconMap[".rtf"] = iconProperties{Icon: "\uf718", Color: "#626262"}     // 
	iconMap[".vue"] = iconProperties{Icon: "\ufd42", Color: "#89e051"}     // ﵂
}

var extIconMapV2 = func() map[string]iconProperties {
	iconMap := make(map[string]iconProperties, len(extIconMapV3))
	for key, value := range extIconMapV3 {
		iconMap[key] = value
	}
	patchFileIconsForNerdFontsV2(iconMap)
	return iconMap
}()

func lazyGitFileIcon(name string, isDir bool, nerdFontVersion int) string {
	...
	iconMap := extIconMapV3
	if nerdFontVersion == 2 {
		iconMap = extIconMapV2
	}
	...
	if isDir {
		return defaultDirectoryIcon.Icon
	}
	return defaultFileIcon.Icon
}
