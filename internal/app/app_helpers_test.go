	...
	tests := []struct {
		...
		},
		{
			...
			input: []string{
				...
				"REPO_OWNER=owner",
				"REPO_REPONAME=repo",
				"LAZYWORKTREE_TYPE=pr",
				"LAZYWORKTREE_NUMBER=123",
				"LAZYWORKTREE_TEMPLATE=pr-{number}-{title}",
				"LAZYWORKTREE_SUGGESTED_NAME=pr-123-title",
				"LAZYWORKTREE_TITLE=Title",
				"LAZYWORKTREE_URL=https://example.com/pr/123",
				"LAZYWORKTREE_DESCRIPTION=Body",
			},
			expected: []string{},
		},
		{
